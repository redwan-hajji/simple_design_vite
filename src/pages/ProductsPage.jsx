...
import biscuts from "../images/biscuts.png"
import lolipop from "../images/red lolipop.png"
...
<span className="relative w-full text-left text-[#FF6B6B] transition-colors duration-300 ease-in-out group-hover:text-white">See all</span>
        ...
        <ProductItem title={"bag"} price={75}  picture={bag}/>
        ...
        <ProductItem title={"biscuts"} price={3} picture={biscuts}/>
        <ProductItem title={"lolipop"} price={1} picture={lolipop}/>
        <ProductItem title={"scissors"} price={7} picture={scissors}/>
        <ProductItem title={"shoes"} price={50} picture={shoes}/>
        </div> 
      </div>
    </>
  )
